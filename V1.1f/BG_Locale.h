      ...
      <div class='divTable'>\
          <div class='divRow'>\
            <div class='divColumn' style='width:{{fieldsize5}}'>\
              <div class='tabheader'>Ъптайм</div>\
...
<body>\
  ...
  <hr>\
    <h1><a style='text-shadow: 2px 1px grey;'>MiniWX станция&#8482; Настройки</a></h1>\
    <form style='width:58%' action='/submit' method='POST'>\
        ...
        <div class='divTable'>\
          <div class='divRow'>\
            ...
            <div class='divColumn'>\
              <fieldset>\
              <legend><h2>Статични IP настройк</h2></legend>\
                <span>\
